...
export default function MusicXMLRenderer({ scoreId, recenter, retry, isFullscreen, currentPage, pagesPerView = 1 }: MusicXMLRendererProps) {
    ...
    const detectMusicLines = () => {
        ...
        if (staffLines.length > 0) {
            ...
            const flattenedLines = staffLines;
            setMusicLines(Array.from(flattenedLines));
